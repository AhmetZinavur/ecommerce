...
public class UserService {
    ...
    protected UserResponse checkUserAndUserPassword(UserLoginRequest loginRequest) {
        return UserMapper.INSTANCE.userToUserResponse(userRepository.findOptionalByUserNameAndPassword(loginRequest.getUserName(), loginRequest.getPassword()).orElseThrow(() -> new UserNameOrPasswordIsWrongException(CustomeException.USER_NAME_OR_PASSWORD_IS_WRONG_EXCEPTION)));
    }
